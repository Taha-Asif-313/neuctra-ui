...
const ReactPageBlock = ({
  ...
  const renderReactComponent = () => {
    ...
    try {
      ...
      return (
        <div key={componentKey} className="w-full h-full p-4 overflow-auto">
          <Component {...props} />
        </div>
      );
    } catch (error) {
  ...
  const getLanguageIcon = (lang) => {
    const icons = {
      javascript: <Code2 className="w-4 h-4 text-yellow-400" />,
      typescript: <Code2 className="w-4 h-4 text-blue-400" />,
      jsx: <Code2 className="w-4 h-4 text-cyan-400" />,
      tsx: <Code2 className="w-4 h-4 text-sky-400" />,
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800 bg-zinc-900/50">
        ...
        {/* Controls */}
        <div className="flex items-center gap-2">
          {/* Refresh Button for Live Preview */}
          {livePreview && (reactComponent || preview) && (
            <button
          ...
          {/* Play Button for React Components */}
          {reactComponent && (
            <button
            ...
            {reactComponent ? (
              ...
              <div className="flex items-center justify-center h-full text-zinc-500">
                <div className="text-center">
                  ...
                  <p className="text-xs mt-2">Add a React component or preview content</p>
                </div>
              </div>
            )}
          </div>
