...
/>`,
    ...
    propsTable={[
      ...
      { prop: "iconClassName", type: "string", default: "—", description: "Styles the calendar icon in the trigger." },
      { prop: "textClassName", type: "string", default: "—", description: "Styles the displayed date text." },
      ...
      { prop: "panelClassName", type: "string", default: "—", description: "Styles the popover panel containing the calendar." },
      { prop: "helperClassName", type: "string", default: "—", description: "Styles the helper/error text below the trigger." },
      { prop: "Calendar.headerClassName", type: "string", default: "—", description: "Styles the month header row (prev/next buttons and label)." },
      { prop: "Calendar.navButtonClassName", type: "string", default: "—", description: "Styles the previous/next month buttons." },
      { prop: "Calendar.monthLabelClassName", type: "string", default: "—", description: "Styles the current month/year label." },
      { prop: "Calendar.weekdaysClassName", type: "string", default: "—", description: "Styles the weekday header row." },
      { prop: "Calendar.weekdayClassName", type: "string", default: "—", description: "Styles each weekday header cell." },
      { prop: "Calendar.daysClassName", type: "string", default: "—", description: "Styles the day grid container." },
      { prop: "Calendar.dayClassName", type: "string", default: "—", description: "Styles each individual day cell." },
    ]}
    a11y={[
