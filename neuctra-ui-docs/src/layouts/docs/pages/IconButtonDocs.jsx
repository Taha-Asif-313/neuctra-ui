...
const IconButtonDocs = () => {
  return (
    <>
      <Metadata
        title="Icon Button Component — React UI for SaaS Dashboards | Neuctra UI"
        description="Build accessible, icon-only React buttons for SaaS apps with Neuctra UI. Supports variants, sizes, and full icon customization for toolbars, cards, and dashboards."
        keywords="react icon button component, saas ui icon button, tailwind icon button react, dashboard ui icon button, icon only button react, accessible icon button, neuctra ui icon button"
      />
