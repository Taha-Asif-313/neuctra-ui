      ...
      <div className="max-w-5xl mx-auto px-4 space-y-10">
        ...
        <header>
          ...
          <p className="text-lg text-gray-400 max-w-3xl leading-relaxed">
            ...
            It supports online/offline indicators, variants, responsive sizing,
            and group stacking.
          </p>
        </header>
...
<Avatar src="..." isOffline />`}
        ...
        <section>
          ...
          <p className="text-gray-300 mb-3">
            ...
            limit visible avatars using <code className="text-primary">max</code>.
          </p>
...
/>`}
        ...
        <section>
          ...
          <p className="text-gray-300 mb-3">
            ...
            <code className="text-primary">ringColor</code> for accent outlines.
          </p>
