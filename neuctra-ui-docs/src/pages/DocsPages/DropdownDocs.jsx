  ...
  return (
    <>
      <Metadata
        ...
        description="Explore the Dropdown component from Neuctra UI — a flexible and accessible React select component with support for single & multi-selection, search, and full customization."
        keywords="Neuctra UI Dropdown, React dropdown component, multi select, searchable dropdown, custom select, React UI library, Tailwind dropdown, select input, Neuctra components, React UI"
        image="https://ui.neuctra.com/og/dropdown-docs-preview.png"
        ogTitle="Dropdown Component — Neuctra UI"
        ogDescription="Build modern, customizable, and accessible dropdowns in React with Neuctra UI’s Dropdown component."
        twitterTitle="Dropdown Component | Neuctra UI"
        twitterDescription="Create interactive select menus with multi-select, search, and custom styles using Neuctra UI’s Dropdown component."
      />
        ...
        <div className="max-w-5xl mx-auto px-4 space-y-10">
          ...
          <header>
            ...
            <p className="text-lg text-gray-400 max-w-3xl leading-relaxed">
              ...
              accessibility, keyboard navigation, and virtualization support. It
              supports single & multi-selection, custom styles, and live search.
            </p>
          </header>
...
/>`}
          ...
          <section>
            ...
            <p className="text-gray-300 mb-3">
              Enable <code className="text-primary">multiSelect</code> to allow
...
/>`}
          ...
          <section>
            ...
            <p className="text-gray-300 mb-3">
              Add <code className="text-primary">searchable</code> to allow
              users to filter options dynamically.
            </p>
