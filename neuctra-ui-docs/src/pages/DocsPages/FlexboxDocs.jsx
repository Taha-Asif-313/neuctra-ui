...
const FlexboxDocs = () => {
      ...
      <div className="max-w-5xl mx-auto px-4 space-y-10">
        ...
        <header>
          ...
          <p className="text-lg text-gray-400 max-w-3xl leading-relaxed">
            ...
            component is a responsive layout wrapper that provides full control
            over direction, alignment, spacing, and wrapping behavior — all
            dynamically adjustable across screen sizes.
          </p>
        </header>
  ...
  <div style={{ background: "#eab308", padding: "12px 24px", borderRadius: 8 }}>Item 3</div>
        ...
        <section>
          ...
          <p className="text-gray-300 mb-3">
            The <code className="text-primary">direction</code> prop accepts an
            object to define layout per breakpoint —{" "}
...
>
  ...
  <div style={{ background: "#34d399", padding: "12px 24px", borderRadius: 8 }}>Right</div>
            ...
            previewContent={
              <div className="p-6 bg-zinc-900 rounded-xl">
                ...
                >
                  ...
                  <div className="bg-blue-400 rounded-lg px-6 py-3">Center</div>
                  <div className="bg-green-400 rounded-lg px-6 py-3">Right</div>
                </Flexbox>
              </div>
            }
          />
        ...
        <section>
          ...
          <p className="text-gray-300 mb-3">
            Apply borders, shadows, or overflow behavior to create card layouts
            or scrollable flex containers.
          </p>
