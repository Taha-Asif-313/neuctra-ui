...
/>`}
            ...
            <div className="space-y-4 text-sm text-gray-300">
              <div className="flex items-start gap-2 text-red-500">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-1">
                    Inline lists require proper spacing via gap classes; avoid
                    using margin on items.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-2 text-red-500">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-1">
                    Always provide items array; empty arrays render nothing.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-2 text-green-500">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-xs mt-1">
                    Custom colors can be applied using primaryTheme=false and
                    primaryColor.
                  </p>
                </div>
              </div>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-200 space-y-1">
              <li>
                Use <code>subItems</code> to create nested lists with proper
                indentation.
              </li>
              <li>
                Inline lists work well for breadcrumbs or horizontal menus.
              </li>
              <li>Use icons to highlight key items.</li>
              <li>Click handlers allow interactive list items.</li>
              <li>
                Customize bullets with <code>bulletClassName</code> or disable
                primaryTheme for custom colors.
              </li>
              <li>
                Combine <code>title</code> and <code>titleIcon</code> for
                sections or group headers.
              </li>
            </ul>
          </section>
