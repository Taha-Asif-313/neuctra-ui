      ...
      <div className="max-w-5xl mx-auto px-4 space-y-10">
        ...
        <header>
          ...
          <p className="text-lg text-gray-400 max-w-3xl leading-relaxed">
            The <span className="text-primary font-semibold">SwitchGroup</span>{" "}
            component provides a simple and customizable way to render multiple
            toggle switches. Ideal for feature controls, preferences, and on/off
            states in forms or dashboards.
          </p>
        </header>
...
/>`}
        ...
        <section>
          ...
          <p className="text-gray-300 mb-3">
            Use the <code className="text-primary">error</code> prop to display
