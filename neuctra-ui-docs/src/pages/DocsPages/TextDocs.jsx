...
const TextDocs = () => {
        ...
        <div className="max-w-5xl mx-auto px-4 space-y-10">
          ...
          <header>
            ...
            <p className="text-lg text-gray-400 max-w-3xl leading-relaxed">
              ...
              component is a flexible way to display text in your app. You can
              choose the font size, color, style, alignment, and even support
              dark mode or hover effects — all without writing CSS.
            </p>
          </header>
  ...
  Welcome to Neuctra UI 🚀
          ...
          <section>
            ...
            <p className="text-gray-400 mb-3">
              Control how big or small your text looks using the{" "}
              <code className="text-primary">size</code> prop.
            </p>
            <CodePreviewBlock
              language="jsx"
              code={`<>
  ...
  <Text size="2xl" weight="bold">2XL Bold</Text>
          ...
          <section>
            ...
            <p className="text-gray-400 mb-3">
              Use <code className="text-primary">color</code> to set your text’s
              color. Built-in options include primary, secondary, success,
              danger, and muted.
            </p>
            <CodePreviewBlock
              language="jsx"
  ...
  <Text color="muted">Muted</Text>
          ...
          <section>
            ...
            <p className="text-gray-400 mb-3">
              Add transformations and decorations like uppercase, italic,
  ...
  This text will truncate when it's too long and will have a hover effect.
          ...
          <section>
            ...
            <p className="text-gray-400 mb-3">
              Pick a <code className="text-primary">baseColor</code> and the
              component will automatically generate a light/dark palette for
              your text.
            </p>
            <CodePreviewBlock
              language="jsx"
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-zinc-800">
                  <tr>
                    ...
                    <td>Choose which HTML tag to render (p, h1, span, etc.)</td>
                  </tr>
                  <tr>
                    <td className="p-3">children</td>
                    <td className="p-3">ReactNode</td>
                    <td>
                      The text content or elements inside the Text component
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="p-3">string</td>
                    <td>
                      Pick a text color (primary, secondary, success, danger,
                      muted, or any hex)
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="p-3">string</td>
                    <td>Set text size (xs, sm, md, lg, xl, 2xl or custom)</td>
                  </tr>
                  <tr>
                    <td className="p-3">weight</td>
                    <td className="p-3">number | string</td>
                    <td>Set the font weight (normal, bold, 400, 700 etc.)</td>
                  </tr>
                  <tr>
                    <td className="p-3">align</td>
                    <td className="p-3">string</td>
                    <td>Align text (left, center, right)</td>
                  </tr>
                  <tr>
                    <td className="p-3">transform</td>
                    <td className="p-3">string</td>
                    <td>
                      Change text casing (uppercase, lowercase, capitalize)
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="p-3">boolean</td>
                    <td>Add line-through to text</td>
                  </tr>
                  <tr>
                    <td className="p-3">truncate</td>
                    <td className="p-3">boolean</td>
                    <td>Cut long text with "..."</td>
                  </tr>
                  <tr>
                    <td className="p-3">selectable</td>
                    <td className="p-3">boolean</td>
                    <td>Allow user to select text</td>
                  </tr>
                  <tr>
                    <td className="p-3">hoverable</td>
                    <td className="p-3">boolean</td>
                    <td>Add a subtle hover effect</td>
                  </tr>
                  <tr>
                    <td className="p-3">darkMode</td>
                    <td className="p-3">boolean</td>
                    <td>Switch to dark mode automatically</td>
                  </tr>
                  <tr>
                    <td className="p-3">baseColor</td>
                    <td className="p-3">string</td>
                    <td>
                      Custom base color to generate a color palette for text
                    </td>
                  </tr>
                  <tr>
                    <td className="p-3">onClick</td>
                    <td className="p-3">function</td>
                    <td>Function to run when text is clicked</td>
                  </tr>
                  <tr>
