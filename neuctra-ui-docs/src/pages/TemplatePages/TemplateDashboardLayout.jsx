...
const dashboardLayoutCode = `import React, { useState } from "react";
import {
  Container,
  Drawer,
  DrawerButton,
...
const DashboardLayoutPreview = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 border border-gray-200 rounded-lg overflow-hidden">
      {/* Header */}
      <header className="bg-white border-b border-gray-200 px-4 py-3">
        <Container className="flex items-center justify-between">
          <div className="flex items-center gap-4">
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <Text variant="h3" className="mb-2">Dashboard Layout Template</Text>
        <Text variant="body1" className="text-gray-600 max-w-2xl mx-auto">
          A responsive dashboard layout with collapsible sidebar navigation, header, and main content area.
          Uses Drawer for mobile-responsive sidebar.
        </Text>
      </div>
      ...
      <CodePreviewBlock
        ...
        language="jsx"
        previewContent={<DashboardLayoutPreview />}
      />
    </div>
  );
}
